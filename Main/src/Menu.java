...
public class Menu {
    ...
    private static String optionName0 = "exit game";
    private static String optionName1 = "new game";
    private static String optionName2 = "how to play";
    private static String optionName3 = "options";
